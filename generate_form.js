...
export default function PostPropertyPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      alert(error.message || "Failed to upload property. Please try again.");
      setLoading(false);
    }
  };
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '2rem' }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input name="down_payment_pct" value={formData.down_payment_pct} onChange={handleChange} type="number" min="0" max="100" placeholder="e.g. 20" style={inputStyle} />
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input name="during_construction_pct" value={formData.during_construction_pct} onChange={handleChange} type="number" min="0" max="100" placeholder="e.g. 30" style={inputStyle} />
                <span style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)', color: '#666' }}>%</span>
              </div>
            </div>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input name="on_handover_pct" value={formData.on_handover_pct} onChange={handleChange} type="number" min="0" max="100" placeholder="e.g. 50" style={inputStyle} />
                <span style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)', color: '#666' }}>%</span>
              </div>
            </div>
          </div>
...
fs.writeFileSync('src/app/client/post-property/page.tsx', code);
